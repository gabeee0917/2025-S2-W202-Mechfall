...
public class PrintNpcDialogOneLetterAtATime : MonoBehaviour
{
    ...
    private void OnDisable()
    {
        if (printCoroutine != null)
        {
            ...
            npcDialog.text = text2print;    
            // had to add this last line after testing in editor, because if leave early, the npcdialog text was 
            // saved cutoff so when try interact again only prints to cutoff point which is not wanted
        }
    }
}
